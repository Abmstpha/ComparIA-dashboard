  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 lg:px-6 py-4">
        <div className="flex items-start lg:items-center justify-between">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors ml-4 flex-shrink-0"
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
        {/* Sidebar */}
        <aside className="sidebar p-4 lg:p-6 space-y-4 lg:space-y-6 overflow-y-auto scrollbar-thin lg:w-80 w-full lg:min-h-0 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-gray-700">
        ...
        {/* Main Content */}
        <main className="main-content p-4 lg:p-6 space-y-4 lg:space-y-6 flex-1 overflow-y-auto">
          {state.isLoading ? (
